...
$(document).ready(function() {
	...
	$('#addEstimateModalBtn').unbind('click').bind('click', function() {
		...
		$("#submitEstimateForm").unbind('submit').bind('submit', function() {
			...
			var dimensionWidth = $("#dimensionWidth").val();
			var dimensionHeight = $("#dimensionHeight").val();
			var estQuantity = $("#estQuantity").val();
		...
		//	if(EstimateName && EstimateStatus) {
				var form = $(this);
				// button loading
				$("#showEstimateBtn").button('loading');
